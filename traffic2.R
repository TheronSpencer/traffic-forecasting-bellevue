...
#hourly time series plots from 3/15/2007-8/31/2019
par(mfrow=c(1,2))
eastHourlyTS <- ts(eastHourly,start=1)
westHourlyTS <- ts(westHourly,start=1)
tE <- 1:length(eastHourlyTS)
tW <- 1:length(westHourlyTS)
plot(tE,eastHourlyTS, type = "l", main = "S203 E. Hourly Traffic Flow 3/15/2007-8/31/2019")
plot(tW,westHourlyTS, type = "l", main = "S203 W. Hourly Traffic Flow 3/15/2007-8/31/2019")
...
tE <- 1:length(eastHourlyTS)
tW <- 1:length(westHourlyTS)
plot(tE, eastHourlyTS, type = "l", main = "S203 E. Hourly Traffic Flow 6/1/2019-8/31/2019")
plot(tW, westHourlyTS, type = "l", main = "S203 W. Hourly Traffic Flow 6/1/2019-8/31/2019")
...
tE <- 1:length(eastHourlyTS)
tW <- 1:length(westHourlyTS)
plot(tE, eastHourlyTS, type = "l", main = "S203 E. Hourly Traffic Flow 8/1/2019-8/31/2019")
plot(tW, westHourlyTS, type = "l", main = "S203 W. Hourly Traffic Flow 8/1/2019-8/31/2019")
...
tE <- 1:length(eastHourlyTS)
tW <- 1:length(westHourlyTS)
plot(tE, eastHourlyTS, type = "l", main = "S203 E. Hourly Traffic Flow 8/25/2019-8/31/2019")
plot(tW, westHourlyTS, type = "l", main = "S203 W. Hourly Traffic Flow 8/25/2019-8/31/2019")
...
plot(tE,eastDailyTS, type = "l", main = paste("S203 E. Daily 3/15/2007-8/31/2019"))
plot(tW,westDailyTS, type = "l", main = paste("S203 W. Daily 3/15/2007-8/31/2019"))
...
tE <- 1:length(eastDailyTS)
tW <- 1:length(westDailyTS)
plot(tE,eastDailyTS, type = "l", main = paste("S203 E. Daily 8/31/2016-8/31/2019"))
plot(tW,westDailyTS, type = "l", main = paste("S203 W. Daily 8/31/2016-8/31/2019"))
...
tE <- 1:length(eastDailyTS)
tW <- 1:length(westDailyTS)
plot(tE,eastDailyTS, type = "l", main = paste("S203 E. Daily 8/31/2018-8/31/2019"))
plot(tW,westDailyTS, type = "l", main = paste("S203 W. Daily 8/31/2018-8/31/2019"))
...
tE <- 1:length(eastDailyTS)
tW <- 1:length(westDailyTS)
plot(tE,eastDailyTS, type = "l", main = paste("S203 E. Daily 6/1/2019-8/31/2019"))
plot(tW,westDailyTS, type = "l", main = paste("S203 W. Daily 6/1/2019-8/31/2019"))
...
tE <- 1:length(eastDailyTS)
tW <- 1:length(westDailyTS)
plot(tE,eastDailyTS, type = "l", main = paste("S203 E. Daily 8/1/2019-8/31/2019"))
plot(tW,westDailyTS, type = "l", main = paste("S203 W. Daily 8/1/2019-8/31/2019"))
...
tE <- 1:length(eastDailyTS)
tW <- 1:length(westDailyTS)
plot(tE,eastDailyTS, type = "l", main = paste("S203 E. Daily 8/25/2019-8/31/2019"))
plot(tW,westDailyTS, type = "l", main = paste("S203 W. Daily 8/25/2019-8/31/2019"))

#' ***

#' # Model Fitting
#' ## Data Imputation using kalman/seadec 
# we will focus on two time series:
# 1) the total daily traffic flow in east direction for last 3 years
# 2) the hourly traffic flow in the east direction for the last 3 months
...
parestimate(hourly3month_ssa, list(c(2,3)), method = "pairs")$periods
parestimate(hourly3month_ssa, list(c(4,5)), method = "pairs")$periods
parestimate(hourly3month_ssa, list(c(6,7)), method = "pairs")$periods
...
diff <- diff(res_det)
diff2 <- diff(diff,lag=24*7)
plot(diff2)
plot(diff2,xlim=c(1700,2000))
...
par(mfrow=c(1,1))
plot(cbind(eastHourlyTS, for_hourly), plot.type="single", col=c("black","red"),
     main="Hourly Traffic Data (6/1/2019-8/31/2019)", lwd=2, xlab="Hour", ylab="Traffic Flow")
...
#fit tbats using just weekly seasonality
...
#fit tbats using just daily seasonality
...
##### tbatsmodel1 is clearly the best fit ##########
tbatsModel1
...
##########comparing three forecasts so far
# par(mfrow=c(3,1))
# plot(cbind(eastHourlyTS, for_hourly), plot.type="single", col=c("black","red"),
...
# 
# rmses <-cbind(model1_rmse,model2_rmse,model3_rmse)
# rmses
#' ***
